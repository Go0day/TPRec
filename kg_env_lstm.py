...
class KGState(object):
    ...
    def __call__(self, user_embed, node_embed, last_node_embed, last_relation_embed, older_node_embed,
        ...
        if self.history_len == 0:
            ...
            return np.concatenate([user_embed, last_node_embed, last_relation_embed, older_node_embed,
                                   older_relation_embed, node_embed])
        else:
...
class BatchKGEnvironment(object):
    def __init__(self, dataset_str, max_acts, max_path_len=3, state_history=1, mode='train'):
        ...
        # Following it's current episode information.
...
# ============================================================================
        ...
        for r, next_node_id in candidate_acts:
            ...
            if next_node_type == USER:
                ...
                '''Definition 3.4. (1-reverse k-hop pattern) 得分函数'''
